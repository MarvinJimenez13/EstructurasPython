...
def buscar_solucion_UCS(conexiones, estado_incial, solucion):
    solucionado = False
    nodos_visitados = []
    nodos_frontera = []
    nodo_incial = Nodo(estado_incial)
    nodo_incial.set_coste(0)
    nodos_frontera.append(nodo_incial)
        ...
        if nodo.get_datos() == solucion:
            ...
            for un_hijo in conexiones[dato_nodo]:
                ...
                if not hijo.en_lista(nodos_visitados):
                    ...
                    #el nuevo valor del coste si es menor
...
if __name__ == "__main__":
    ...
    estado_incial = 'Malaga'
    solucion = 'Santiago'
    nodo_solucion = buscar_solucion_UCS(conexiones, estado_incial, solucion)
    #mostrar resultado
    resultado = []
    nodo = nodo_solucion
